<?php
	...
	if($count > 0) {
		...
		echo '<div class="row">';
		echo '<div class="col-1.5 text-middle"><h5><u>Reminder ID</u></h5></div>';
    	...
    	echo '<div class="col-1 text-middle"><h5><u>Date</u></h5></div>';
		echo '</div>';
		foreach ($results as $row) {
			echo '<div class="row">';
			echo '<div class="col-1 text-middle">'.$row['Reminder_ID'].'</div>';
		...
		$results = $stmt->fetchall();
		echo '<div class="row">';
		echo '<div class="col-1 text-middle"><h5><u>First Name</u></h5></div>';
		echo '<div class="col-1 text-middle"><h5><u>Last Name</u></h5></div>';
		echo '<div class="col-1 text-middle"><h5><u>Email</u></h5></div>';
		echo '</div>';
		foreach ($results as $row) {
			echo '<div class="row">';
			echo '<div class="col-1 text-middle">'.$row['First_Name'].'</div>';
			echo '<div class="col-1 text-middle">'.$row['Last_Name'].'</div>';
			echo '<div class="col-1 text-middle">'.$row['Email'].'</div>';
			echo '</div>';
		}
	}
	else{
